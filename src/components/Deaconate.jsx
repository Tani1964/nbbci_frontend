  ...
  return (
    <Box py={10} px={6}>
      ...
      <VStack spacing={8} align="stretch">
        {/* Deaconess Adebisi Ifegbesan */}
        <Flex borderWidth="1px" borderRadius="md" p={6} boxShadow="sm" direction={{ base: "column", md: "row" }}>
          <Box flexShrink={0} mb={{ base: 4, md: 0 }} mr={{ md: 6 }}>
            <Image
              ...
              objectFit="cover"
              src={Two}
              alt="Deaconess Adebisi Ifegbesan"
              fallbackSrc="https://via.placeholder.com/200"
            />
          </Box>
          <Box>
            <Text fontSize="xl" fontWeight="bold">
              DEACONNESS ADEBISI ATINUKE IFEGBESAN
            </Text>
        ...
        <Flex borderWidth="1px" borderRadius="md" p={6} boxShadow="sm" direction={{ base: "column", md: "row" }}>
          <Box flexShrink={0} mb={{ base: 4, md: 0 }} mr={{ md: 6 }}>
            <Image
              ...
              objectFit="cover"
              src={Three}
              alt="Deaconess Maria Gaadi"
              fallbackSrc="https://via.placeholder.com/200"
            />
          </Box>
          <Box>
            <Text fontSize="xl" fontWeight="bold">
              DEACONNESS MARIA DOOM GAADI
            </Text>
            <Text color="#A8518A" fontSize="lg" fontWeight="semibold">
              Deaconess
            </Text>
        ...
        <Flex borderWidth="1px" borderRadius="md" p={6} boxShadow="sm" direction={{ base: "column", md: "row" }}>
          <Box flexShrink={0} mb={{ base: 4, md: 0 }} mr={{ md: 6 }}>
            <Image
              ...
              objectFit="cover"
              src={One}
              alt="Deacon Rotimi Adeoye"
              fallbackSrc="https://via.placeholder.com/200"
            />
          </Box>
          <Box>
            <Text fontSize="xl" fontWeight="bold">
              DEACON ROTIMI ADEBOWALE ADEOYE
            </Text>
            <Text color="#A8518A" fontSize="lg" fontWeight="semibold">
              Deacon
            </Text>
